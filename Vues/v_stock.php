        ...
        <div class="contenue effet-carte ">
            <header>
                <div class="row header-search">
                    <div class="control">
                        <input type="search" name="" placeholder="Rechercher.." id="" class="form-control">
                    </div>
            ...
            <table>
                ...
                <?php
                    foreach ($stocks as $stock) {
                        ...
                        echo '<td>
                                <a href="./v_stockUpdate.php?id_stock=' . $stock->id_stock . '">
                                ...
                                <a href="./v_stockDelete.php?id_stock=' . $stock->id_stock . '">
